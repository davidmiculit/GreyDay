...
<div class="nav-wrapper" style="height: 100px">
  <nav style="height: 100px;">
    <div class="nav-wrapper black" style="box-shadow: 0px 0px 2px black;">
    <a href="index.php" style="display: flex; justify-content: center;">
    <img src="./static/logoicon.png" alt="logo" id="logo" class="brand-logo glow-image" style="max-height:100px" /></a>
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        <li class="black" id="search-bar">
          <form action="product_catalogue.php">
            <div class="white-text row" style="padding-left: 20px;">
              <input type="text" name="query" placeholder="Browse products..." style="font-family: 'BLKCHCRY'"
