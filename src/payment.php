...
<body>
  <div class="container">
    ...
    <div class="selectable-card grey darken-4" id="no-hover">
      <div class="row">
        <h4 class="orange-text bold" style="padding-top: 10px; padding-left: 500px">Payment</h4>
      </div>
        ...
        <div class="col s8">
          <div class="row">
            <div class="input-field col s6">
              ...
              <input id="name" type="text" placeholder="Name" name="card_name" class="validate white-text">
          ...
          <div class="row">
            <div class="input-field">
              ...
              <textarea placeholder="Home Number" id="home"
