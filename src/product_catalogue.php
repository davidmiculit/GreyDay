...
<body>
  <head>
    ...
    <title>GreyDay - Product Catalogue</title>
    <?php 
            ...
            <div class="section" style="margin-bottom: 100px;">
              <div class="col unglow">
                <ul id="filter_dropdown" class="dropdown-content black">
                  ...
                  <li><a class="cyan-text page-title" onclick="select_category(this)">Clothing</a></li>
                  <li><a class="cyan-text page-title" onclick="select_category(this)">Accessories</a></li>
                  <li><a class="cyan-text page-title" onclick="select_category(this)">Shoes</a></li>
                </ul>
            ...
            <div class="section">
              <div class="col unglow">
                <ul id="choose_dropdown" class="dropdown-content black">
                  ...
                  <li><a class="cyan-text page-title" onclick="select_brand(this)">GreyDay</a></li>
                  <li><a class="cyan-text page-title" onclick="select_brand(this)">Nike</a></li>
                  <li><a class="cyan-text page-title" onclick="select_brand(this)">Jordan</a></li>
                </ul>
