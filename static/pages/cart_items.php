          ...
          <table class="responsive-table">
            <tbody>
              <?php
                ...
                if ($displayShipping === 0) $displayShipping = "<span class='underline'>RON$displayShipping</span>";
                else $displayShipping = "RON$displayShipping";
                ...
                echo("<tr><th >Produse Totale:</th><td >$cartItemCount</td></tr>");
                echo("<tr><th >Cost Transport:</th><td >");echo("$displayShipping $displaySVoucher</td></tr>");
                echo("<tr><th >Promo Voucher:</th><td >$displayPVoucher</td></tr>");
                echo("<tr><th>Total Suma:</th><td>RON$sumTotal</td></tr>");
